...
test_that("the further developed prioritylasso leads to the same results as the CRAN version", {
  ...
  expect_equal(pl2, pl2_cran, max_diffs = 20, max_lines = 10)
  expect_equal(pl2a, pl2a_cran, max_diffs = 20, max_lines = 10)
  expect_equal(pl2b, pl2b_cran, max_diffs = 20, max_lines = 10)
  expect_equal(pl3, pl3_cran, max_diffs = 20, max_lines = 10)
  expect_equal(pl3a, pl3a_cran, max_diffs = 20, max_lines = 10)
  expect_equal(pl3b, pl3b_cran, max_diffs = 20, max_lines = 10)
